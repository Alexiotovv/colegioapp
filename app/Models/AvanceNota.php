...
class AvanceNota extends Model
{
    protected $table = 'notas_avance';
    ...
    {
        return $this->hasOne(ConclusionDescriptivaAvance::class, 'nota_avance_id');
    }
