<?php
// app/Http/Controllers/AvanceRegistroNotaExportController.php
...
class AvanceRegistroNotaExportController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        $sheet->setCellValue('A1', 'REGISTRO DE AVANCE DE NOTAS');
        ...
        // Descargar
        $fileName = 'avance_notas_'.$aula->id.'_'.$curso->id.'_'.$periodo->id.'_'.date('Ymd_His').'.xlsx';
        $tempFile = tempnam(sys_get_temp_dir(), 'avance_notas_');
