{{-- resources/views/avance-libretas/previsualizar-aula.blade.php --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <title>Previsualizar Avance Libretas - Aula {{ $aula->nombre }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="toolbar">
            <div>
                <strong>Previsualización de Avance Libretas</strong> - Aula: {{ $aula->nombre }} - Total: {{ $matriculas->count() }} alumnos
            </div>
            <div>
        ...
        @endphp
            ...
            <h1>INFORME DE AVANCE DE LAS COMPETENCIAS DEL ESTUDIANTE - {{ $anio }}</h1>
