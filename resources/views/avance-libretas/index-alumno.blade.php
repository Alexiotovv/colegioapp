{{-- resources/views/avance-libretas/index-alumno.blade.php --}}
@extends('layouts.app')

@section('title', 'Exportar Avance Libreta por Alumno')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4>
            ...
            Exportar Avance Libreta por Alumno
        </h4>
        <a href="{{ route('admin.avance-libretas.index') }}" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-2"></i> Volver a Exportar Avance Libretas
        </a>
    </div>
...
$(document).ready(function () {
    ...
    function buscarAlumnos(termino) {
        ...
        $.ajax({
            url: '{{ route("admin.avance-libretas.alumno.buscar") }}',
            method: 'GET',
            data: { q: termino },
...
function previsualizarAlumno(matriculaId) {
    ...
    const url = '/admin/avance-libretas/previsualizar?matricula_id=' + matriculaId + '&periodo_id=' + periodoId;
