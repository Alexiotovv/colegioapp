        ...
        <div class="tree-item">
            <div class="tree-header" onclick="toggleChildren(this)">
                <div class="tree-title">
                    ...
                    <span class="badge bg-secondary">{{ $nivel->evaluaciones ? $nivel->evaluaciones->count() : 0 }} evaluaciones</span>
                </div>
            ...
            <div class="tree-children">
                @if($nivel->evaluaciones && $nivel->evaluaciones->count() > 0)
                    @foreach($nivel->evaluaciones as $evaluacion)
                    ...
                    @endforeach
                @else
                    <div class="empty-message">No hay evaluaciones registradas para este nivel</div>
                @endif
            </div>
        </div>
    </div>
