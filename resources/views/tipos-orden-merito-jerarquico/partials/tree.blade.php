        ...
        <div class="tree-item">
            <div class="tree-header" onclick="toggleChildren(this)">
                <div class="tree-title">
                    ...
                    <span class="badge bg-secondary">{{ $nivel->tiposOrdenMerito ? $nivel->tiposOrdenMerito->count() : 0 }} tipos</span>
                </div>
            ...
            <div class="tree-children">
                @if($nivel->tiposOrdenMerito && $nivel->tiposOrdenMerito->count() > 0)
                    @foreach($nivel->tiposOrdenMerito as $tipo)
                    <div class="tree-level-2" data-tipo-id="{{ $tipo->id }}">
                        <div class="tree-item">
                            <div class="tree-header">
                                <div class="tree-title">
                                    <i class="fas fa-trophy" style="color: #c8a951;"></i>
                    ...
                    @endforeach
                @else
                    <div class="empty-message">No hay tipos de orden de mérito registrados para este nivel</div>
                @endif
            </div>
        </div>
    </div>
